...
```markdown
| Permisos y Obligaciones | AGPL-3.0 (Open Source) | Licencia Comercial |
| :--- | :---: | :---: |
| **Uso en proyectos Open Source** | ✅ Sí | ✅ Sí |
| **Uso en software propietario** | ❌ No* | ✅ Sí |
| **Atribución y Mérito** | ✅ Obligatorio | ✅ Sí |
| **Modificar el código** | ✅ Sí | ✅ Sí |
| **Garantía y Soporte** | ❌ No | ✅ Opcional |
```
---
